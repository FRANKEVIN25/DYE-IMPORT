...
const categoriesData = [
  { id: 1, name: 'Motor', image: '/images/motor.png', count: '+1200 Artículos' },
  { id: 2, name: 'Frenos', image: '/images/frenos.png', count: '+800 Artículos' },
  { id: 3, name: 'Suspensión', image: '/images/suspencion.jpg', count: '+600 Artículos' },
  { id: 4, name: 'Eléctrico', image: '/images/electrico.jpg', count: '+950 Artículos' },
  { id: 5, name: 'Transmisión', image: '/images/transmision.jpg', count: '+400 Artículos' },
  { id: 6, name: 'Iluminación', image: '/images/Iluminacion.jpg', count: '+300 Artículos' }
];

// PRODUCTOS DESTACADOS DEL CARRUSEL INFERIOR
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-0.5 rounded-3xl overflow-hidden shadow-2xl border border-white/10">
          {statsData.map((stat, i) => (
            <div key={i} className="bg-gray-900 p-8 flex flex-col items-center text-center group hover:bg-gray-850 transition-colors">
              ...
              />
              <div className="text-gray-200 text-xs font-bold uppercase tracking-widest">{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
