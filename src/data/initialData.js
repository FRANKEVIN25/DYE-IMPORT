...
export const companyInfo = {
  ...
  about: {
    ...
    values: [
      { title: 'Calidad', description: 'Productos con respaldo y garantía' },
      { title: 'Honestidad', description: 'Precios justos y transparentes' },
      { title: 'Servicio', description: 'Atención personalizada y profesional' },
      { title: 'Compromiso', description: 'Con nuestros clientes y su seguridad' }
    ]
  }
};
